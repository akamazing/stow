...
local configDir = awful.util.get_configuration_dir() 
...
sysmon.widget.battery = redflat.widget.battery(
	...
	{ timeout = 60, widget = redflat.gauge.icon.single, monitor = { is_vertical = true, icon =  configDir .. "themes/colored/widget/battery.svg"}}
)
-- network speed
...
sysmon.widget.network = redflat.widget.net(
	{ interface = "wlan0", speed = { up = 6 * 1024^2, down = 6 * 1024^2 }, autoscale = false },
	-- custom style
...
awful.screen.connect_for_each_screen(
	function(s)
		...
		-- tags
		awful.tag({ "Main", "Web", "Code", "Terminal", "Free" }, s, { al[5], al[6], al[6], al[4], al[3] })
