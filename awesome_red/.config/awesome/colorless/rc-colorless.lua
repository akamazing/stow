...
volume.buttons = awful.util.table.join(
	awful.button({}, 4, function() volume.widget:change_volume({show_notify = true})                end),
	awful.button({}, 5, function() volume.widget:change_volume({show_notify = true, down = true }) end),
	awful.button({}, 2, function() volume.widget:mute({show_notify = true})                         end),
...
--------------------------------------------------------------------------------
local kbindicator = {}
redflat.widget.keyboard:init({ "Laptop", "HHKB" })
