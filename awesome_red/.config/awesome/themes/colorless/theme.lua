...
theme.icon = {
	...
	keyboard = theme.path .. "/common/keyboard.svg",
	updates  = theme.path .. "/common/updates.svg",
	battery  = theme.path .. "/common/battery.svg",
	audio    = theme.path .. "/common/audio.svg",
...
function theme:init()
	...
	self.gauge.audio.blue = {
		...
		icon    = self.icon.audio, -- volume icon
	...
	------------------------------------------------------------
	self.widget.battery = {
		icon         = self.icon.battery,  -- widget icon
		timeout = 30,   -- update timeout
		notify  = {icon = theme.icon.battery},   -- redflat notify style (see theme.float.notify)
	...
	------------------------------------------------------------
	self.widget.pulse = {
		notify = {icon = theme.icon.audio},  -- redflat notify style (see theme.float.notify)
	...
	------------------------------------------------------------
	self.widget.mail = {
		icon        = self.icon.mail,  -- widget icon
		notify      = {},                -- redflat notify style (see theme.float.notify)
	...
	------------------------------------------------------------
	self.widget.updates = {
		icon        = self.icon.updates,  -- widget icon
		notify      = {},                -- redflat notify style (see theme.float.notify)
	...
	self.float.brightness = {
		notify = { icon = theme.icon.brightness },  -- redflat notify style (see theme.float.notify)
	}
